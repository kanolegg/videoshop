...
if (isset($_GET['url'])) {
	if (!$category = $core->getCategoryByUrl($_GET['url']))
...
// echo json_encode(['Длина', 'Тип витой пары', 'Категория', 'Макс. скорость передачи данных', 'Материал проводника', 'Тип разъема', 'Защита замка'], JSON_UNESCAPED_UNICODE);
        	...
        	<section class="py-3">
        		<div class="container">
	        		...
	        		<div class="rounded border bg-white p-3" id="content">
		        			...
		        			<div class="row">
		        				...
		        				<div class="col-md-4">
		        					<div class="mb-3">
		        						...
		        						<input type="text" name="article" id="article" autocomplete="off" class="form-control">
		        					</div>
		        				</div>
		        			</div>
		        			<div class="row">
		        				<div class="col-md-6">
		        					<div class="mb-3">
		        						...
		        						<input type="text" name="manufacturer" id="manufacturer" autocomplete="off" class="form-control">
		        					</div>
		        				</div>
		        				<div class="col-md-6">
		        					<div class="mb-3">
		        						<label class="form-label" for="amount">Количество</label>
		        						<input type="number" value="1" name="amount" id="amount" autocomplete="off" class="form-control">
		        					</div>
		        				</div>
		        			</div>
		        			<div class="mb-3">
		        		...
		        		<div class="row g-3 mb-3" id="specs"></div><!-- 
		        			<button type="button" class="btn btn-primary rounded-pill" id="spec-add">
