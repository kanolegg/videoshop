...
if (isset($_GET)) {
    ...
    $where = $core->addWhere($where, "`category` = '{$category['url']}'");
    ...
    if ($_GET['query']) {
        $where = $core->addWhere($where, "`brand` = '".htmlspecialchars($_GET['query']))."'";
        $where = $core->addWhere($where, "`model` = '".htmlspecialchars($_GET['query']), false)."'";
    }
                                                        ...
                                                        <div class="w-100">
                                                            ...
                                                            <div class="d-flex justify-content-between align-items-center">
                                                                ...
                                                                <?php if (!in_array($p['id'], $cart)):?>
                                                                    <button class="btn btn-primary text-white addToCart" data-id="<?=$p['id']?>" data-bs-toggle="tooltip" data-bs-placement="top" title="В корзину" type="button">
